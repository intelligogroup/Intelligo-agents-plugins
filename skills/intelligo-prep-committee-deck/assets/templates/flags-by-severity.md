...
|----------|---------|-------|
| Legal (civil + criminal) | ✓ | [Federal + state, 15yr] |
| Regulatory (sanctions, OFAC, PEP) | ✓ | |
| Asset (liens, bankruptcy, UCC) | ✓ | |
| Education | ✓ | [Verification level] |
| Employment | ✓ | [Years checked] |
| Media | ✓ | |
| Social media | ✓ / not at this level | |
...
- **Severity:** Red
- **Finding:** [What was specifically found — full sentence with context, not just the flag title. Include amounts, parties, dates, what happened.]
- **Source:** [Link + date]
...
[Same structure as red, more compact. Severity row says "Yellow".]
...
|----------|---------|--------|
| Info | [Finding text, not just title] | [Source] |
